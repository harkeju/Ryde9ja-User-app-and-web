                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: CustomImage(
                          fit: BoxFit.cover,
                          image: '${Get.find<SplashController>().configModel.baseUrls.itemImageUrl}/${_imageList[itemController.productSelect]}',
                        ),
                      ),
                      SizedBox(height: 10),
                ...
                Expanded(flex: 6, child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        QuantityButton(
                          isIncrement: false, quantity: itemController.cartIndex != -1 ? Get.find<CartController>().cartList[itemController.cartIndex].quantity : itemController.quantity,
                        ...
                        SizedBox(width: 30),
                        QuantityButton(
                          isIncrement: true, quantity: itemController.cartIndex != -1 ? Get.find<CartController>().cartList[itemController.cartIndex].quantity : itemController.quantity,
                      ...
                      SizedBox(width: 400, child: Row(children: [
                        Expanded(flex:5, child: Container(
                          child: CustomButton(
                            buttonText: itemController.cartIndex != -1 ? 'already_added_in_cart'.tr : (Get.find<SplashController>().configModel.moduleConfig.module.stock && stock <= 0) ? 'out_of_stock'.tr : 'add_to_cart'.tr,
                            onPressed: (itemController.cartIndex == -1 && (!Get.find<SplashController>().configModel.moduleConfig.module.stock || stock > 0)) ?  () {
